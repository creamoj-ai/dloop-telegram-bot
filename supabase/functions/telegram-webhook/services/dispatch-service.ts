...
${order.delivery_fee_shown ? `💰 Compenso: €3.00 fisso + €${(order.delivery_fee_shown - 3.00).toFixed(2)} (${((order.delivery_fee_shown - 3.00) / 0.65).toFixed(1)} km × €0.65) = €${order.delivery_fee_shown.toFixed(2)}` : ""}
